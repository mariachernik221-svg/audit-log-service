...
class LayerBoundariesTest {
    ...
    void layeredArchitectureIsRespected() {
        layeredArchitecture()
                ...
                .layer("Domain").definedBy("com.auditlog.domain..")
                .layer("Repository").definedBy("com.auditlog.repository..")
                .layer("Service").definedBy("com.auditlog.service..")
                .layer("Api").definedBy("com.auditlog.api..")
    ...
    void domainDependsOnNothingInsideAuditlog() {
        ArchRule rule = ArchRuleDefinition.noClasses()
                .that().resideInAPackage("com.auditlog.domain..")
                .should().dependOnClassesThat()
                .resideInAnyPackage(
                        "com.auditlog.api..",
                        "com.auditlog.service..",
                        "com.auditlog.repository..");
    ...
    void repositoryDependsOnlyOnDomain() {
        ArchRule rule = ArchRuleDefinition.noClasses()
                .that().resideInAPackage("com.auditlog.repository..")
                .should().dependOnClassesThat()
    ...
    void serviceDoesNotDependOnApi() {
        ArchRule rule = ArchRuleDefinition.noClasses()
                .that().resideInAPackage("com.auditlog.service..")
                .should().dependOnClassesThat()
    ...
    void apiDoesNotDependOnRepositoryDirectly() {
        ArchRule rule = ArchRuleDefinition.noClasses()
                .that().resideInAPackage("com.auditlog.api..")
                .should().dependOnClassesThat()
